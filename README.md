...
It was a challenge to resist developing this into a full website so with more time, I would have wanted the add branded colours, more robust typography styles, I had intially wanted to add a dark mode but realized that with how much SCSS I ended up with, that would probably be overkill.